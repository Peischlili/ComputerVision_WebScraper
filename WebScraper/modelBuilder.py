...
# Helper function to create blocks of layers of Yolo3 model
...
# replicate Darknet's Yolo3 model in keras
# concerning custom trained model with certain classes
# nb of filters on certain layers are changed to fit classes (instructions given in Github ReadMe of Darknet)
def make_yolov3_model():
    ...
    # Layer 80 => 82 : change 255 filters to 18 for 1 class
    yolo_82 = _conv_block(x, [{'filter': 1024, 'kernel': 3, 'stride': 1, 'bnorm': True, 'leaky': True, 'layer_idx': 80},
                              {'filter': 18, 'kernel': 1, 'stride': 1, 'bnorm': False, 'leaky': False,
    ...
    # Layer 92 => 94 : change 255 filters to 18 for 1 class
    ...
    # Layer 99 => 106 : change 255 filters to 18 for 1 class
...
# weightReader is a helper to load yolo3 weights files
class WeightReader:
